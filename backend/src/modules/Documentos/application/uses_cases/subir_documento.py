...
from modules.Documentos.application.ports.file_storage import FileStoragePort
from modules.Documentos.domain.entities.documento import Documento
from modules.Documentos.domain.Enum.estado_documetno import TipoDocumento
from modules.Documentos.domain.repository.documento_repository import (
    DocumentoRepository,
)
